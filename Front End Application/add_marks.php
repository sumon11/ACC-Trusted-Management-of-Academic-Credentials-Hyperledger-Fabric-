...
<body>
	...
	<div class="row">
		<div class = "col-md-3"></div>
		<div class = "col-md-6">
			<form method="post" action="http://localhost:8080/api/addMarks" enctype="multipart/form-data">
				<input type="text" name="mKey" placeholder="Key" class="form-control"><br>
				<input type="text" name="studentid" placeholder="Stuent ID" class="form-control"><br>
				<input type="text" name="sessional" placeholder="Theory Marks" class="form-control" id = "number1"><br>
				<input type="text" name="practical" placeholder="Practical Marks" class="form-control" id = "number1"><br>
